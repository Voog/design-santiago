  ...
  <div class="layout-header__container">
    <div class="layout-header__top">
      ...
      {% if show_language_menu_popover %}
        <button class="menu-language-btn ico-flags ico-flag-{{ page.language_code }} js-toggle-menu-language js-menu-language-popover-btn js-prevent-sideclick" data-lang-code="{{ page.language_code }}" data-sideclick="prevent" {{ edy_intro_add_lang }}>
