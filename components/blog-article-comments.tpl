<section id="article-comments" class="article-comments inner content-area">
  ...
  <div class="article-comment-form{% unless comment.valid? %} form_with_errors{% endunless %}">
    {% commentform %}
      {% include "blog-article-variables" %}

      <div class="article-comment-form__field{% if comment_body_error %} form_field_with_errors{% endif %}">
      ...
      <div class="article-comment-form__details" data-js-selector="comment-form-details" data-state--display="{% if comment.valid? %}none{% else %}block{% endif %}">
        <div class="article-comment-form__inputs">
          <div class="article-comment-form__field article-comment-form__field--inline{% if comment_name_error %} form_field_with_errors{% endif %}">
          ...
          <div class="article-comment-form__field article-comment-form__field--inline{% if comment_email_error %} form_field_with_errors{% endif %}">
        ...
        <div class="article-comment-form__btns form_submit">
          <input class="article-comment-form__btn" type="submit" value="{{ "submit" | lc }}">
        </div>
      </div>
    {% endcommentform %}
  </div>
