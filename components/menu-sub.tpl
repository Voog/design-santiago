      ...
      {% for level_2 in level_1.visible_children %}
        {% if hide_product_related_pages %}
          {% unless level_2.layout_title == product_list_layout or level_2.layout_title == product_layout %}
            {% menulink level_2 wrapper-tag="li" wrapper-class="menu-sub__item" selected-class="menu-sub__item--selected" current-class="menu-sub__item--current" untranslated-class="menu-sub__item--untranslated" %}
          {% endunless %}
        {% else %}
          {% menulink level_2 wrapper-tag="li" wrapper-class="menu-sub__item" selected-class="menu-sub__item--selected" current-class="menu-sub__item--current" untranslated-class="menu-sub__item--untranslated" %}
        {% endif %}
